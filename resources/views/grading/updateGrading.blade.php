...
<section class="content">
  <div class="panel panel-info">
    <div class="panel-heading"><h3>Update Scoring</h3>
    </div>
    <div class="panel-body">
      <form class="form-horizontal" role="form" method="post" action="/saveUpdateGrading">
        {{ csrf_field() }}
        ...
        <div class="col-md-8">
          <div class="form-group">
            ...
            <textarea class="form-control" id="project_title" name="project_title" rows="3" value="{{$data->project_title}}" disabled="disabled">{{$data->project_title}}</textarea>
          </div>
        </div>
        <div class="col-md-12">
          <div class="col-md-4">
